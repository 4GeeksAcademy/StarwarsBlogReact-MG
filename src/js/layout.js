      ...
      <BrowserRouter basename={basename}>
        <ScrollToTop>
          ...
          <Routes>
            ...
            <Route path="/planetDetails/:id" element={<PlanetDetail />} />
            <Route path="/starshipDetails/:id" element={<StarshipDetail />} />
            <Route path="/vehicleDetails/:id" element={<VehicleDetail />} />
